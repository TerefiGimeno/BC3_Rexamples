...
# create a list with my individual data sets
...
for (i in 1:length(myMon)){
  with(empty[[i*2-1]], plot(A_area ~ PAR, pch = 19, col = 'blue', xlim = c(0 ,2500), ylim = c(-5, 28)))
  with(empty[[i*2]], points(A_area ~ PAR, pch = 19, col = 'red'))
}